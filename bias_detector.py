"""
This module provides functionality to detect biased or offensive words in user input.

The `load_bias_words` function reads a list of bias-indicating words from a file, and
the `check_bias` function checks if the user's input contains any of those words.
"""
...
def load_bias_words(file_path):
    ...
    Returns:
        set: A set of words read from the file, transformed to lowercase for case-insensitive comparison.
    """
